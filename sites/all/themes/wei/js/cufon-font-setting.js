...
//GothamLight, GothamBook, GothamBold, MyriadProLightCond, MyriadProLight, MyriadProRegular, MyriadProSemibold, Foglihten
...
Cufon.replace('ul.link-list-2 li a, #footer .midSect .textBox p, .small-banner p, .postCont p, .breadcum-diff ul li a', { fontFamily: 'MyriadProRegular', hover: 'true' });
Cufon.replace('ul.gall-box-list li .gall-box h4', { fontFamily: 'MyriadProLightCond'});
Cufon.replace('.breadcum ul li.active a', { fontFamily: 'GothamBold'});
